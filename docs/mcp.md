...
| `vision_limelight_pipelines_list` | `ftc vision limelight pipelines list --json` |
| `vision_limelight_pipelines_validate` | `ftc vision limelight pipelines validate --json` |
